  ...
  recommendationService: {
    ...
    getRecommendations: async (userId, limit = 20) => {
      try {
        ...
        return module.exports.recommendationService.getPopularTracks(limit);
      }
    },
    ...
    generateDailyMixes: async (userId, mixCount = 3) => {
      try {
        ...
        if (allGenres.length === 0) {
          const popularTracks = await module.exports.recommendationService.getPopularTracks(30);
          return [{
            name: 'Daily Mix 1',
        ...
        const popularTracks = await module.exports.recommendationService.getPopularTracks(15);
        return [{
          name: 'Daily Mix 1',
          description: 'Popular tracks you might enjoy',
          tracks: popularTracks
